...
\begin{document}
    ...
    \begin{enumerate}
        \item 座標空間内の点Pが次の条件\,\ref{uem_tok_2023_f_sci_06_q:1}，%
            \ref{uem_tok_2023_f_sci_06_q:2}\,をともに満たすとき，%
            点Pが動きうる範囲$V$の体積を求めよ．
            \begin{enumerate}
                \item $\mathrm{OP}\leqq\sqrt{3}$
                    \label{uem_tok_2023_f_sci_06_q:1}
                \item 線分OPと$S$は，共有点を持たないか，点Pのみを共有点に持つ．
                    \label{uem_tok_2023_f_sci_06_q:2}
            \end{enumerate}
        \item 座標空間内の点Nと点Pが次の条件\,\ref{uem_tok_2023_f_sci_06_q:3}，%
            \ref{uem_tok_2023_f_sci_06_q:4}，\ref{uem_tok_2023_f_sci_06_q:5}\,をすべて満たすとき，%
            ...
            \begin{enumerate}[resume]
                \item $\mathrm{ON}+\mathrm{NP}\leqq\sqrt{3}$
                    \label{uem_tok_2023_f_sci_06_q:3}
                \item 線分ONと$S$は共有点を持たない．
                    \label{uem_tok_2023_f_sci_06_q:4}
                \item 線分NPと$S$は，共有点を持たないか，点Pのみを共有点に持つ．
                    \label{uem_tok_2023_f_sci_06_q:5}
            \end{enumerate}
    \end{enumerate}
\end{document}
