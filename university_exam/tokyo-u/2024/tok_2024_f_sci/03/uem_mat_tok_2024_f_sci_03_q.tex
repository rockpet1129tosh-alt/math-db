...
\begin{document}
    座標平面上を次の規則\,\ref{uem_mat_tok_2024_f_sci_03_q:1}，%
    \ref{uem_mat_tok_2024_f_sci_03_q:2}\,に従って1秒ごとに動く点Pを考える．

    \begin{myenua}
        \item 最初に，Pは点$(2,\;1)$にいる．\label{uem_mat_tok_2024_f_sci_03_q:1}
        \item ある時刻でPが点$(a,\;b)$にいるとき，その1秒後にはPは
            ...
            \end{itemize}
            にいる．
            \label{uem_mat_tok_2024_f_sci_03_q:2}
    \end{myenua}
    以下の問いに答えよ．ただし，\ref{uem_mat_tok_2024_f_sci_03_q:3}\,については，結論のみを書けばよい．
    \begin{enumerate}
        \item Pがとりうる点の座標をすべて求めよ．\label{uem_mat_tok_2024_f_sci_03_q:3}
