...
\begin{document}
    \setcounter{figure}{0}
    \textsf{図\ref{fig/hsm_tok_2008_1st_03_01_q}}で，
    ...
    {\par \centering
        ...
        \includegraphics[width=.8\linewidth]%
            {\subfix{fig_hsm_tok_2008_1st_03/fig_hsm_tok_2008_1st_03_01_q.pdf}}
            \captionof{figure}{} \label{fig/hsm_tok_2008_1st_03_01_q}
    \par}
    %
    \begin{enumerate}
        ...
        \item \textsf{図\ref{fig/hsm_tok_2008_1st_03_02_q}}は，
            \textsf{図\ref{fig/hsm_tok_2008_1st_03_01_q}}において，
            点Pの$x$座標が正の数のとき，
            ...
            {\par \centering
                \setlength{\abovecaptionskip}{5pt}
                \includegraphics[width=.8\linewidth]%
                    {\subfix{fig_hsm_tok_2008_1st_03/fig_hsm_tok_2008_1st_03_02_q.pdf}}
                    \captionof{figure}{} \label{fig/hsm_tok_2008_1st_03_02_q}
            \par}
        \end{enumerate}
