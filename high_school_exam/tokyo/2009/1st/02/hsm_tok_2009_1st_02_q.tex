...
\begin{document}
    ...
    \begin{tcolorbox}[title=［先生が示した問題］,
        ...
        \textsf{図\ref{fig/hsm_tok_2009_1st_02_01_q}}のように，円Oの円周を12等分する点に，
        ...
        \textsf{図\ref{fig/hsm_tok_2009_1st_02_01_q}}において，1組の向かい合う点を選び，
        ...
        \begin{minipage}{\linewidth}
            ...
            {\centering
                ...
                \includegraphics%
                    {\subfix{fig_hsm_tok_2009_1st_02/fig_hsm_tok_2009_1st_02_01_q.pdf}}
                    \captionof{figure}{} \label{fig/hsm_tok_2009_1st_02_01_q}
            }
        \end{minipage}
    \end{tcolorbox}
    %
    ...
    \begin{tcolorbox}[title=［Sさんのグループが作った問題］,
        ...
        \textsf{図\ref{fig/hsm_tok_2009_1st_02_02_q}}のように，円Oの円周を24等分する点に，
        1から24までの自然数の番号を，小さい順で時計回りに付ける．

        1から24までの番号を付けた点のうち，2点を結んでできる線分が円Oの直径となるとき，
        その2点を向かい合う点とする．

        \textsf{図\ref{fig/hsm_tok_2009_1st_02_02_q}}において，
        ...
        \begin{minipage}{\linewidth}
            ...
            {\centering
                \setlength{\abovecaptionskip}{5pt}
                \includegraphics%
                    {\subfix{fig_hsm_tok_2009_1st_02/fig_hsm_tok_2009_1st_02_02_q.pdf}}
                    \captionof{figure}{} \label{fig/hsm_tok_2009_1st_02_02_q}
            }
        \end{minipage}
        %
    \end{tcolorbox}
