...
\begin{document}
    \setcounter{figure}{0}
    \textsf{図\ref{fig/hsm_tok_2019_2nd_03_01_q}}で，点Oは原点，%
    ...
    \begin{minipage}{\linewidth}
        ...
        \includegraphics%
            {\subfix{fig_hsm_tok_2019_2nd_03/fig_hsm_tok_2019_2nd_03_01_q.pdf}}
            \captionof{figure}{} \label{fig/hsm_tok_2019_2nd_03_01_q}
        }
    \end{minipage}
    ...
    \begin{enumerate}
        ...
        \item \textsf{図\ref{fig/hsm_tok_2019_2nd_03_02_q}}は，%
            \textsf{図\ref{fig/hsm_tok_2019_2nd_03_01_q}}において，%
            ...
            \begin{minipage}{\linewidth}
                ...
                {\centering
                    \setlength{\abovecaptionskip}{5pt}
                    \includegraphics%
                        {\subfix{fig_hsm_tok_2019_2nd_03/fig_hsm_tok_2019_2nd_03_02_q.pdf}}
                        \captionof{figure}{} \label{fig/hsm_tok_2019_2nd_03_02_q}
                }
            \end{minipage}
    \end{enumerate}
