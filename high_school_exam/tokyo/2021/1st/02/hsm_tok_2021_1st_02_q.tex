...
\begin{document}
    ...
    図\textsf{\ref{fig/hsm_tok_2021_1st_02_01_q}}において，1組の向かい合う点を選び，それぞれの点の番号のうち，
    ...
    \textsf{\ref{fig/hsm_tok_2021_1st_02_02_q}}のように，円Oの円周を24等分する点に，
    1から24までの自然数の番号を，小さい順で時計回りに付ける．

    1から24までの番号を付けた点のうち，2点を結んでできる線分が円Oの直径となるとき，
    その2点を向かい合う点とする．

    図\textsf{\ref{fig/hsm_tok_2021_1st_02_02_q}}において，
