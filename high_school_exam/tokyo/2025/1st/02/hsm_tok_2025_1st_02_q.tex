...
\begin{document}
    ...
    \textsf{図\ref{fig/hsm_tok_2025_1st_02_01_q}}において，1組の向かい合う点を選び，それぞれの点の番号のうち，
    ...
    {\par \centering
        \includegraphics[width=.65\linewidth]%
            {fig_hsm_tok_2025_1st_02/fig_hsm_tok_2025_1st_02_01_q.pdf}
    ...
    {\par \centering
        \includegraphics[width=.65\linewidth]%
            {fig_hsm_tok_2025_1st_02/fig_hsm_tok_2025_1st_02_02_q.pdf}
