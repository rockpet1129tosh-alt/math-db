...
\begin{document}
    \setcounter{figure}{0}
    \textsf{図\ref{fig/hsm_tok_2018_1st_05_01_q}}に示した立体ABCD--EFGHは，
    ...
    {\par \centering
        ...
        \includegraphics%
            {\subfix{fig_hsm_tok_2018_1st_05/fig_hsm_tok_2018_1st_05_01_q.pdf}}
            \captionof{figure}{} \label{fig/hsm_tok_2018_1st_05_01_q}
    \par}
    ...
    \begin{enumerate}
        \item 次の\:\myboxa{　　　}\:の中の「\textsf{お}」「\textsf{か}」に当てはまる
            ...
            \textsf{図\ref{fig/hsm_tok_2018_1st_05_01_q}}において，
        ...
        \item 次の\:\myboxa{　　　}\:の中の「\textsf{き}」「\textsf{く}」「\textsf{け}」に当てはまる
            ...
            \textsf{図\ref{fig/hsm_tok_2018_1st_05_02_q}}は，
            \textsf{図\ref{fig/hsm_tok_2018_1st_05_01_q}}において，
            ...
            \begin{minipage}{\linewidth}
                ...
                {\par \centering
                    \setlength{\abovecaptionskip}{3pt}
                    \includegraphics%
                        {\subfix{fig_hsm_tok_2018_1st_05/fig_hsm_tok_2018_1st_05_02_q.pdf}}
                        \captionof{figure}{} \label{fig/hsm_tok_2018_1st_05_02_q}
                \par}
            \end{minipage}
    \end{enumerate}
\end{document}
