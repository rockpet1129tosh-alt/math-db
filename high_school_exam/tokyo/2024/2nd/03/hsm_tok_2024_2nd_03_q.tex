...
\begin{document}
    \setcounter{figure}{0}
    \textsf{図\ref{fig/hsm_tok_2024_2nd_03_01_q}}で，
    ...
    {\par \centering
        ...
        \includegraphics[width=.8\linewidth]%
            {fig_hsm_tok_2024_2nd_03/fig_hsm_tok_2024_2nd_03_01_q.pdf}
    ...
    \begin{enumerate}
        ...
        \item \textsf{図\ref{fig/hsm_tok_2024_2nd_03_02_q}}は，
            ...
            {\par \centering
                \setlength{\abovecaptionskip}{5pt}
                \includegraphics[width=.8\linewidth]%
                    {fig_hsm_tok_2024_2nd_03/fig_hsm_tok_2024_2nd_03_02_q.pdf}
