...
\begin{document}
    \setcounter{figure}{0}
    \textsf{図\ref{fig/hsm_tok_2012_2nd_04_01_q}}で，%
    四角形ABCDは，平行四辺形である．
    ...
    \begin{minipage}{\linewidth}
        ...
        \includegraphics%
            {\subfix{fig_hsm_tok_2012_2nd_04/fig_hsm_tok_2012_2nd_04_01_q.pdf}}
            \captionof{figure}{} \label{fig/hsm_tok_2012_2nd_04_01_q}
        }
    \end{minipage}
    \vspace{.1\baselineskip}
    %
    \begin{enumerate}
        \item \textsf{図\ref{fig/hsm_tok_2012_2nd_04_01_q}}において，%
        ...
        \item \textsf{図\ref{fig/hsm_tok_2012_2nd_04_02_q}}は，%
            \textsf{図\ref{fig/hsm_tok_2012_2nd_04_01_q}}において，%
            ...
            \begin{enumerate}
                ...
                \item[②] 次の\:\myboxa{　　　}\:の中の「\textsf{う}」「\textsf{え}」%
                    ...
                    \textsf{図\ref{fig/hsm_tok_2012_2nd_04_02_q}}において，%
            ...
            \begin{minipage}{\linewidth}
                ...
                \par{\centering
                    ...
                    \includegraphics%
                        {\subfix{fig_hsm_tok_2012_2nd_04/fig_hsm_tok_2012_2nd_04_02_q.pdf}}
                        \captionof{figure}{} \label{fig/hsm_tok_2012_2nd_04_02_q}
                \par}
            \end{minipage}            
        \end{enumerate}
