...
\begin{document}
    ...
    \textsf{図\ref{fig/hsm_tok_2012_2nd_02_01_q}}のように，円Oの円周を12等分する点に，
    ...
    図\textsf{\ref{fig/hsm_tok_2012_2nd_02_01_q}}において，1組の向かい合う点を選び，それぞれの点の番号のうち，
    ...
    {\par \centering
        \includegraphics[width=.65\linewidth]%
            {\subfix{fig_hsm_tok_2012_2nd_02/fig_hsm_tok_2012_2nd_02_01_q.pdf}}
            \captionof{figure}{} \label{fig/hsm_tok_2012_2nd_02_01_q}
    \par}
    %
    \end{tcolorbox}
    \begin{enumerate}
    ...
    \textsf{\ref{fig/hsm_tok_2012_2nd_02_02_q}}のように，円Oの円周を24等分する点に，
    1から24までの自然数の番号を，小さい順で時計回りに付ける．

    1から24までの番号を付けた点のうち，2点を結んでできる線分が円Oの直径となるとき，
    その2点を向かい合う点とする．

    図\textsf{\ref{fig/hsm_tok_2012_2nd_02_02_q}}において，
    ...
    {\par \centering
        \includegraphics[width=.65\linewidth]%
            {\subfix{fig_hsm_tok_2012_2nd_02/fig_hsm_tok_2012_2nd_02_02_q.pdf}}
            \captionof{figure}{} \label{fig/hsm_tok_2012_2nd_02_02_q}
    \par}
    %
    \end{tcolorbox}
    %
