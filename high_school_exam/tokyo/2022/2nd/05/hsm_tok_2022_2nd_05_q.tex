...
\begin{document}
    \setcounter{figure}{0}
    \textsf{図\ref{fig/hsm_tok_2022_2nd_05_01_q}}に示した立体A--BCDEは，%
    ...
    {\par \centering
        ...
        \includegraphics%
            {\subfix{fig_hsm_tok_2022_2nd_05/fig_hsm_tok_2022_2nd_05_01_q.pdf}}
            \captionof{figure}{} \label{fig/hsm_tok_2022_2nd_05_01_q}
    \par}
    ...
    \begin{enumerate}
        ...
        \item 次の\:\myboxa{　　　}\:の中の「\textsf{く}」「\textsf{け}」「\textsf{こ}」%
            ...
            \textsf{図\ref{fig/hsm_tok_2022_2nd_05_02_q}}は，%
            \textsf{図\ref{fig/hsm_tok_2022_2nd_05_01_q}}において，%
            ...
            \begin{minipage}{\linewidth}
                ...
                {\par \centering
                    \setlength{\abovecaptionskip}{3pt}
                    \includegraphics%
                        {\subfix{fig_hsm_tok_2022_2nd_05/fig_hsm_tok_2022_2nd_05_02_q.pdf}}
                        \captionof{figure}{} \label{fig/hsm_tok_2022_2nd_05_02_q}
                \par}
            \end{minipage}
    \end{enumerate}
\end{document}
